...
class AnnouncementDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final String formattedPublishDate =
        DateFormat('dd.MM.yyyy HH:mm').format(announcement.publishDate);
    final String? formattedEndDate = announcement.endDate != null
        ? DateFormat('dd.MM.yyyy HH:mm').format(announcement.endDate!)
        : null;
            ...
            child: Column(
              ...
              children: [
                ...
                AttachmentsSection(
                    ...
                    onGetFileNameFromUrl:
                        _getFileNameFromUrl), // Bu satırda değişiklik yapıldı

                const SizedBox(height: 15),

                TagSection(tags: announcement.tags),
